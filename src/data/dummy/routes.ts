...
export const routes: Route[] = [
  ...
  // ── 弱デガジェ締め後の起き攻め（DR・微歩き・前ステップの各パターン） ──
  {
    ...
    properties: {
      ...
      vsWakeup: 'その場・後ろ受け身どちらも密着でOK（後ろ受け身は最速だと少し遠い）',
      useWhen: '基本択',
      onBlock: '概ね安全（-2 前後）',
      risk: '低',
    },
  ...
  },
  {
    ...
    properties: {
      ...
      vsWakeup: 'その場は確定間合い、後ろ受け身は歩き足しが必要',
      useWhen: 'ガードで固まる相手に',
      onBlock: '—（投げ）',
      risk: '中',
    },
  ...
  },
  {
    ...
    properties: {
      ...
      vsWakeup: 'その場・後ろ受け身どちらも前ステで投げ間合いに入る',
  ...
  // ── 中ランヴェルセ締め後の起き攻め（再帰・サイクル） ──
  {
    ...
    properties: {
      ...
      frameAdvantage: '+2（2中K持続当て）',
      vsWakeup: 'その場向け。後ろ受け身されると2中Kが先端になり弱くなる',
  ...
  },
  {
    ...
    properties: {
      ...
      vsWakeup: 'その場・後ろ受け身どちらも空振りでタイミングを合わせられる',
  ...
  // ── マネージュ・ドレ後の起き攻め ──────────────
  {
    ...
    properties: {
      ...
      frameAdvantage: '+2（受け身方向で前後する）',
      vsWakeup: '受け身なしのため常に同じ間合い',
